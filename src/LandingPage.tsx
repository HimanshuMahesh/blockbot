...
>
  <div className="container mx-auto px-4 text-center bg-gray-900 bg-opacity-70 py-12 rounded-lg">
    ...
    <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
      Your AI-powered blockchain chatbot for all your blockchain-related queries and insights.Transfer Funds and draft Smart Contracts Securely, and Easily!
    </p>
    <Link
      to="/Chatbot"
    ...
    >
      ...
      <section className="py-20 bg-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-green-400 mb-12">What BlockBot Can Do</h2>
      ...
      <footer className="bg-gray-800 py-8">
        <div className="container mx-auto px-4 text-center text-gray-400">
          <p>&copy; 2024 BlockchainGPT. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
